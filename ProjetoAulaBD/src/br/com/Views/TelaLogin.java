...
public class TelaLogin extends javax.swing.JFrame {
    ...
    public TelaLogin() {
        ...
        if (conexao != null) {
            {
                ImageIcon iconeVerde = new ImageIcon("src/img/database_icon.png");
                lblIcone.setIcon(iconeVerde);
            }
        } else {
            ImageIcon iconeVermelho = new ImageIcon("src/img/_database_icon.png");
...
pst.setString(1, Txt Usuario.getUsuario).getText
pst.setString(2, Txt Senha.getText());
